...
def register_crm_routers(app) -> None:
    from routers.crm import (
        access_templates, ai_interviews, apply, candidate_profiles, candidates, credit_notes, customers, dashboards,
        employees, files, finance, holidays, leave_applications, leave_policies, masters, me,
        me_profile, notifications, opportunities, opportunity_attachments, outreach, projects,
        reports, requirements, resumes, settings, slots, template_requests, timesheets, users_admin,
    )
    for module in (
        ...
        candidates, candidate_profiles, ai_interviews, projects, timesheets,
        finance, credit_notes, employees, dashboards, reports, apply, template_requests,
        slots, outreach, holidays, leave_policies, leave_applications,
    ):
